...
export type DataFormulatorStatus = { status: 'online' | 'offline'; online: boolean; url: string; message: string }
export type SystemStatus = { java: Record<string, unknown>; pythonWorker: Record<string, unknown>; llm: Record<string, unknown>; dataFormulator: DataFormulatorStatus }
